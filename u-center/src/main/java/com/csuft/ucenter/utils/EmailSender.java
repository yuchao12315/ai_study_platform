...
public class EmailSender {
    ...
    private EmailSender() {
        //这里的密码是开启STMP的密码 mrwtyhntizxebdfb
        //qq  azuuauuoeqaabdbi
        // 163邮箱 QXJTMGBRZROSKCEJ
        EmailSender.config(EmailSender.SMTP_QQ(false), "904798389@qq.com", "azuuauuoeqaabdbi");
    }
    ...
    /**
     * 发送邮件 如果超时 让用户自己重新发请求
     * @param mailAddress
     * @param content
     */
    public static void  sendMailCode(String mailAddress,String content){
        try{
            EmailSender.subject("邮件验证码发送")
                    .from("清梦")
                    .text(content)
                    .to(mailAddress)//2290313929
                    .send();
        }catch (Exception e){
            e.printStackTrace();
        }
    ...
    public static void main(String[] args) throws MessagingException {
        EmailSender.subject("邮件验证码发送")
                .from("清梦")
                .text("这是发送的内容：121353")
                .to("2290313929@qq.com")//2290313929
                .send();
    }
}
